...
/**
 * Main class for App Support menu option¶
 *
 * @author Ioan-Alexandru Chirita
 */
public class AppSupportActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Toolbar
        AppBarLayout appBarLayout = findViewById(R.id.app_support_app_bar_layout);
        Toolbar mainToolbar;
        ...
        NavigationView navigationView = findViewById(R.id.nav_view_app_support);
        ...
        navigationView.setCheckedItem(R.id.nav_app_support);
        ...
        TextView phoneContact = findViewById(R.id.contact_phone_number);
        TextView mailContact = findViewById(R.id.contact_email);

        // Open call phone application
        phoneContact.setOnClickListener(this::goToPhoneCallSupport);

        // Open email phone application
        mailContact.setOnClickListener(this::goToEmailSupport);
    }
    ...
    public void goToPhoneCallSupport(View view) {
        Intent callIntent = new Intent(Intent.ACTION_CALL);
        TextView phoneTxtView = findViewById(R.id.contact_phone_number);
        String phoneCallNumber = "tel:" + phoneTxtView.getText().toString();
        callIntent.setData(Uri.parse(phoneCallNumber));

        if (checkSelfPermission(Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
            startActivity(callIntent);
        } else {
            if (shouldShowRequestPermissionRationale(Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(AppSupportActivity.this, "It requires permission for access your local storage!", Toast.LENGTH_LONG).show();
            }
    ...
    public void goToEmailSupport(View view) {
        TextView emailTxtView = findViewById(R.id.contact_email);
